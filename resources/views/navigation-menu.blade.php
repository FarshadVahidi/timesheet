        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if(auth()->user()->hasRole('user'))
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('users.event.edit', auth()->user()->id) }}"
                                        :active="request()->routeIs('users.event.edit')">
                            {{ __('Activity') }}
                        </x-jet-nav-link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('users.event.show', auth()->user()->id) }}"
                ...
                @if(auth()->user()->hasRole('administrator'))
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('admins.user.create') }}"
                                        :active="request()->routeIs('admins.user.create')">
                            {{ __('Add New User') }}
                        </x-jet-nav-link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('admins.Azienda.index') }}"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->hasRole('user'))
                ...
                <x-jet-responsive-nav-link href="{{ route('users.event.edit', auth()->user()->id) }}"
                                           :active="request()->routeIs('users.event.edit')">
                    {{ __('Activity') }}
                </x-jet-responsive-nav-link>
            ...
            @if(auth()->user()->hasRole('administrator'))
                ...
                <x-jet-responsive-nav-link href="{{ route('admins.user.create') }}"
                                           :active="request()->routeIs('admins.user.create')">
                    {{ __('Add New User') }}
                </x-jet-responsive-nav-link>

                <x-jet-responsive-nav-link href="{{ route('admins.user.index') }}"
                                           :active="request()->routeIs('admins.user.index')">
                    {{ __('Activity For Each User') }}
                </x-jet-responsive-nav-link>
