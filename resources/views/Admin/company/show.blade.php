            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                @section('mainContent')
                    ...
                    <form class="row g-3" name="myForm" id="myForm"
                          action="{{ route('admins.Company.update', $company->id) }}" method="POST"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="p_iva" id="p_iva"
                                   value="{{ old('p_iva') ?? $company->p_iva}}">
                        </div>

                        <div class="col-md-6">
                            <div class="form-group d-flex flex-column py-4">
                                <a href="{{route('admins.Contract.show', $company->id)}}"
                                   class="btn btn-info">{{__('Show Contract')}}</a>
                            </div>
                        </div>
